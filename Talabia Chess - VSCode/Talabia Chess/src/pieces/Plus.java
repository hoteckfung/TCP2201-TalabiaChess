// Created and wrote by [Ho Teck Fung]
// Controller
...
public class Plus extends Piece {
    ...
    private boolean isValidMove(int distanceR, int distanceC, int newR, int newC) {
        ...
        /*
         * If distanceR is not zero, stepR is assigned the value of distanceR /
         * Math.abs(distanceR), which will be either 1 or -1 depending on the direction
         * of movement.
         * If distanceR is zero, indicating no movement along the rows, stepR is
